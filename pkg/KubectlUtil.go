...
type ArgsProcessor interface {
	MappingFor(resourceOrKindArg string) (*meta.RESTMapping, error)
}
...
//func (a *ResourceProcessor) ResourceTypeOrNameArgs(args ...string) {
...
//// aliases found in it
//func (a *ResourceProcessor) ReplaceAliases(input string) string {
//	replaced := []string{}
...
//}
//
//func (a *ResourceProcessor) AddError(err error) {
//	if err == nil {
//		return
//	}
//	a.errs = append(a.errs, err)
...
//func (a *ResourceProcessor) ResourceTypes(types ...string) {
...
func (r *ResourceProcessor) MappingFor(resourceOrKindArg string) (*meta.RESTMapping, error) {
	fullySpecifiedGVR, groupResource := schema.ParseResourceArg(resourceOrKindArg)
	gvk := schema.GroupVersionKind{}
	restMapper := r.mapper.mapper
